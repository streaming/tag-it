...
duringInitialization:d}),this.options.showAutocompleteOnFocus&&(!d&&this.options.showAutocompleteAfterTagManipulation)&&setTimeout(function(){f._showAutocomplete()},0),this.options.placeholderText&&this.options.hidePlaceholderOnVisibleTags&&this.tagInput.removeAttr("placeholder"))},removeTag:function(a,c){var d=this;c="undefined"===typeof c?this.options.animate:c;a=b(a);this._removingTag=!0;this._trigger("onTagRemoved",null,a);if(!1!==this._trigger("beforeTagRemoved",null,{tag:a,tagLabel:this.tagLabel(a)})){if(this.options.singleField){var f=
this.assignedTags(),g=this.tagLabel(a),f=b.grep(f,function(a){return a!=g});this._updateSingleTagsField(f)}c?(a.addClass("removed"),f=this._effectExists("blind")?["blind",{direction:"horizontal"},"fast"]:["fast"],f.push(function(){a.remove()}),a.fadeOut("fast",function(){d._removingTag=!1}).hide.apply(a,f).dequeue()):(a.remove(),this._removingTag=!1);this._trigger("afterTagRemoved",null,{tag:a,tagLabel:this.tagLabel(a)});this.options.placeholderText&&(!this.tagInput.attr("placeholder")&&0===this._tags().length)&&
this.tagInput.attr("placeholder",this.options.placeholderText)}},removeTagByLabel:function(a,b){var d=this._findTagByLabel(a);if(!d)throw"No such tag exists with the name '"+a+"'";this.removeTag(d,b)},removeAll:function(){var a=this;this._tags().each(function(b,d){a.removeTag(d,!1)})}})})(jQuery);